...
株式会社Honkomaの企業ウェブサイトです。ルーティーンワークの自動化、AI導入支援、CodexやOpenClawなどAIツールの導入支援を提供するテクノロジーカンパニーのマルチページサイトです。React + TypeScript + Vite + Tailwind CSS + React Routerで構築されています。
