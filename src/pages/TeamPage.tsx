  ...
  const teamMembers = [
    {
      ...
      message: '購買体験における「ワクワク」を大切にしています。商品やサービスとの出会いの瞬間の高揚感、それを手に入れる喜び、使う楽しさ。そうした感動的な体験こそが、売り手と買い手の双方に真の満足をもたらすと信じています。Quick Clipは、テクノロジーの力でこのワクワクを最大化し、すべての人がハッピーになれる購買体験を実現します。',
      social: {
